        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentalEquipmentID = table.Column<int>(nullable: false),
                    RentalStart = table.Column<DateTime>(nullable: false),
                    RentalUserID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rentals", x => x.RentalID);
                    table.ForeignKey(
                        name: "FK_Rentals_Equipments_RentalEquipmentID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rentals_RentalEquipmentID",
                table: "Rentals",
                column: "RentalEquipmentID",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Rentals_RentalUserID",
                table: "Rentals",
                column: "RentalUserID");
